###########################################################################
## Makefile generated for component 'Embedded_Ex3'. 
## 
## Makefile     : Embedded_Ex3.mk
## Generated on : Mon Jun 05 21:01:16 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Embedded_Ex3.elf
...
PRODUCT_NAME              = Embedded_Ex3
MAKEFILE                  = Embedded_Ex3.mk
MATLAB_ROOT               = E:/Matlab2022a
MATLAB_BIN                = E:/Matlab2022a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/aminsaveh/Documents/MATLAB
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/AMINSA~1/DOCUME~1/MATLAB/R2022a/ARDUIN~1/ARDUIN~2/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Embedded_Ex3.elf
...
DEFINES_STANDARD = -DMODEL=Embedded_Ex3 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = Embedded_Ex3.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/Embedded_Ex3_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Embedded_Ex3_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Embedded_Ex3_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Embedded_Ex3.o : $(START_DIR)/Embedded_Ex3_ert_rtw/Embedded_Ex3.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Embedded_Ex3_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
