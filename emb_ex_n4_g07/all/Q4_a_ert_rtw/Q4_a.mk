###########################################################################
## Makefile generated for component 'Q4_a'. 
## 
## Makefile     : Q4_a.mk
## Generated on : Sat Apr 22 23:32:46 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Q4_a
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Q4_a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Q4_a_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils
...
DEFINES_STANDARD = -DMODEL=Q4_a -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/Q4_a_ert_rtw/Q4_a.c

MAIN_SRC = $(START_DIR)/Q4_a_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/Q4_a_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Q4_a_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Q4_a.o : $(START_DIR)/Q4_a_ert_rtw/Q4_a.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Q4_a_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
