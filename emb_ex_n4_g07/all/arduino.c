 ...
 * C/C++ source code generated on : Sat Apr 22 02:29:54 2023
 *
 ...
 * Model version                  : 1.7
 * Simulink Coder version         : 9.7 (R2022a) 13-Nov-2021
 * C/C++ source code generated on : Sat Apr 22 02:17:46 2023
 *
 * Target selection: ert.tlc
 * Embedded hardware selection: Atmel->AVR
 * Code generation objectives: Unspecified
...
#define Ex3_StateChart_IN_NO_ACTIVE_CHILD ((uint8_T)0U)
#define Ex3_StateChart_IN_state1         ((uint8_T)1U)
#define Ex3_StateChart_IN_state2         ((uint8_T)2U)
...
void Ex3_StateChart_step(void)
{
  ...
  if (Ex3_StateChart_DW.is_active_c3_Ex3_StateChart == 0U) {
    ...
    Ex3_StateChart_DW.is_B = Ex3_StateChart_IN_state1;
  } else {
    if (Ex3_StateChart_DW.is_C == Ex3_StateChart_IN_D) {
      if (Ex3_StateChart_U.d) {
        ...
        /* Outport: '<Root>/g' */
        Ex3_StateChart_Y.g = true;
        Ex3_StateChart_DW.is_D = Ex3_StateChart_IN_NO_ACTIVE_CHILD;
        Ex3_StateChart_DW.is_C = Ex3_StateChart_IN_G;
    ...
    if (Ex3_StateChart_DW.is_B == Ex3_StateChart_IN_state1) {
      if (Ex3_StateChart_DW.c) {
        ...
        Ex3_StateChart_DW.is_B = Ex3_StateChart_IN_state2;
      }

      /* case IN_state2: */
    } else if (Ex3_StateChart_U.b && (Ex3_StateChart_DW.is_D == Ex3_StateChart_IN_D2))
    {
      /* Outport: '<Root>/s1' */
      Ex3_StateChart_Y.s1 = true;
...
void loop()
{
  Ex3_StateChart_U.a = digitalRead(a);
  Ex3_StateChart_U.b = digitalRead(b);
  Ex3_StateChart_U.d = digitalRead(d);
  Ex3_StateChart_U.e = digitalRead(e);
  digitalWrite(state1,Ex3_StateChart_Y.s1);
  digitalWrite(state2,Ex3_StateChart_Y.s2);
  digitalWrite(d1,Ex3_StateChart_Y.d1);
  digitalWrite(d2,Ex3_StateChart_Y.d2);
  digitalWrite(g,Ex3_StateChart_Y.g);
  Ex3_StateChart_step();
  delay(100);
}